...
import { accounts } from "@arbitrum/testnode-core/accounts.js";
import { writeChainConfig } from "@arbitrum/testnode-core/chain-config.js";
import { clampDepositAmount } from "@arbitrum/testnode-core/deposit-amount.js";
import { composeRestart, composeUp, waitForRpc } from "@arbitrum/testnode-core/docker.js";
import { execOrThrow } from "@arbitrum/testnode-core/exec.js";
import { deployTestErc20 } from "@arbitrum/testnode-core/fee-token.js";
import { ZERO_ADDRESS } from "@arbitrum/testnode-core/init-helpers.js";
import { getL3ParentChainFundingPlan } from "@arbitrum/testnode-core/l3-parent-chain-funding.js";
import {
	patchGeneratedL2NodeConfig,
	patchGeneratedL3NodeConfig,
} from "@arbitrum/testnode-core/node-config-patches.js";
import {
	erc20Abi,
	...
	rollupAbi,
	walletClient,
} from "@arbitrum/testnode-core/rpc.js";
import {
	finishActiveRun,
	logRunEvent,
...
import {
	deployRollupViaSdk,
	prepareNodeConfigFromDeployment,
} from "@arbitrum/testnode-core/sdk-chain.js";
import { installSnapshotRelease } from "@arbitrum/testnode-core/snapshot-release.js";
import {
	DEFAULT_SNAPSHOT_ID,
	captureSnapshot,
	hasSnapshot,
...
import type { InitState } from "@arbitrum/testnode-core/state.js";
import {
	createState,
	getNextPendingStep,
	loadState,
	...
	markStepFailed,
	saveState,
} from "@arbitrum/testnode-core/state.js";
import {
	...
	getL2ChildWeth,
} from "@arbitrum/testnode-core/token-bridge.js";
import { ensureValidatorWalletStaked } from "@arbitrum/testnode-core/validator-wallet.js";
	...
	return {
		"deploy-l2-rollup": async (state) => {
			...
			await deployRollupViaSdk({
				chainConfigPath: resolve(CONFIG_DIR, "l2_chain_config.json"),
				chainId: 412346,
				...
				deploymentOutputPath: resolve(CONFIG_DIR, "l2_deployment.json"),
				chainInfoOutputPath: resolve(CONFIG_DIR, "l2_chain_info.json"),
				rawNodeConfigOutputPath: resolve(CONFIG_DIR, "l2-nodeConfig.raw.json"),
			});
